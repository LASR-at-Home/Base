...
from doing_laundry.states.classify_category import ClassifyCategory
...
class ScanShelves(yasmin.State):
    ...
    Reads from ROS 2 params:
        doing_laundry.cabinet.shelves              — list of shelf IDs
        doing_laundry.cabinet.shelves.<id>.torso_lift_joint
        doing_laundry.cabinet.shelves.<id>.look_point
        doing_laundry.cabinet.shelves.<id>.polygon
        doing_laundry.cabinet.shelves.<id>.z_min
        doing_laundry.cabinet.shelves.<id>.z_max
    ...
    def execute(self, blackboard) -> str:
        ...
        try:
            shelf_ids = (
                self.node.get_parameter("doing_laundry.cabinet.shelves")
                .get_parameter_value()
                .string_array_value
            )
    ...
    def _get_shelf_config(self, shelf_id: str) -> bool:
        ...
        try:
            prefix = f"doing_laundry.cabinet.shelves.{shelf_id}"
