    ...
    def __init__(self, default):
        ...
        with self:
            smach.StateMachine.add(
                ...
                transitions={"success": "FACE_PERSON", "failed": "CHECK_OPEN_DOOR"},
            )
            smach.StateMachine.add(
                "FACE_PERSON",
                FacePerson(default),
                transitions={
                    "success": "CHECK_AVAILABLE_EXIT",
                    "failed": "FACE_PERSON",
                },
            )
            smach.StateMachine.add(
                "CHECK_AVAILABLE_EXIT",
                CheckAvailableExit(default),
                transitions={
                    "success": "NEGOTIATE",
                    "failed": "CHECK_OPEN_DOOR",
            ...
            smach.StateMachine.add(
                "NEGOTIATE",
                Negotiate(default),
                transitions={"success": "success", "failed": "NEGOTIATE"},
            )
