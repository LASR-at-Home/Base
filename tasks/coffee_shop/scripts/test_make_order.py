...
import smach
import rospy
from coffee_shop.phases.phase_2.states import MakeOrder, CheckOrder, LoadOrder, WaitForOrder, GoToCounter
...
if __name__ == "__main__":
    ...
    with sm:
        sm.add('GO_TO_COUNTER', GoToCounter(context), transitions={'done' : 'MAKE_ORDER'})
