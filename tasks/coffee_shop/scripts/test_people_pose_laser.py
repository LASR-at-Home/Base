...
if __name__ == "__main__":
    ...
    shapely = rospy.ServiceProxy('/lasr_shapely/points_in_polygon_2d', PointsInPolygon2D)
        ...
        for detection in detections.detected_objects:
            if detection.name == "person":
                ...
                if corners is not None:
                    waiting_area = shapely(corners, filtered_points) if corners else None
                    ...
                    if len(points_inside_area):
                        ...
                        marker_msg = create_point_marker(point[0], point[1], point[2], i)
