...
class Phase2(smach.StateMachine):
    def __init__(self, context):
        ...
        with self:
            ...
            smach.StateMachine.add('CHECK_ORDER', CheckOrder(context), transitions={'correct' : 'DELIVER_ORDER', 'incorrect' : 'INVALIDATE_ORDER'})
            smach.StateMachine.add('INVALIDATE_ORDER', InvalidateOrder(context), transitions={'done' : 'CHECK_ORDER'})
