...
class Phase2(smach.StateMachine):
    def __init__(self, base_controller, head_controller, voice_controller, yolo, tf, pm, speech, shapely, start_head_mgr, stop_head_mgr):
        ...
        with self:
            ...
            smach.StateMachine.add('CHECK_ORDER', CheckOrder(yolo, tf, pm, shapely, start_head_mgr, stop_head_mgr), transitions={'correct' : 'LOAD_ORDER', 'incorrect' : 'INVALIDATE_ORDER'})
            ...
            smach.StateMachine.add('DELIVER_ORDER', DeliverOrder(base_controller, voice_controller, pm, speech), transitions={'done' : 'HAND_OVER_ORDER'})
