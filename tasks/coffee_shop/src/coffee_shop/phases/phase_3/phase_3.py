...
class Phase3(smach.StateMachine):
    def __init__(self, base_controller, voice_controller, yolo, tf, pm, shapely):
        ...
        with self:
            ...
            smach.StateMachine.add('LOOK_FOR_PERSON', LookForPerson(yolo, tf, pm, shapely), transitions={'found' : 'GO_TO_PERSON', 'not found' : 'LOOK_FOR_PERSON'})
