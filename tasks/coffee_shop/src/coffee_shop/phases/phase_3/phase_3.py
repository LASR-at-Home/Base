...
class Phase3(smach.StateMachine):
    def __init__(self, base_controller, voice_controller, yolo, tf, pm, shapely, start_head_mgr, stop_head_mgr):
        ...
        with self:
            ...
            smach.StateMachine.add('LOOK_FOR_PERSON', LookForPerson(yolo, tf, pm, shapely, start_head_mgr, stop_head_mgr), transitions={'found' : 'GO_TO_PERSON', 'not found' : 'LOOK_FOR_PERSON'})
