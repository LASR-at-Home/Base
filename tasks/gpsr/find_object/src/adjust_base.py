...
class Rotate(smach.State):
    ...
    def execute(self, userdata):
        ...
        pub = rospy.Publisher('/mobile_base_controller/cmd_vel', Twist, queue_size=10, latch=True)
    ...
    def __init__(self):
        ...
        with self:
            ...
            smach.StateMachine.add(
                "BODY_PIX_DETECTION",
                DetectHipCenter(),
                transitions={"move_left": "ADJUST_BASE_LEFT", "move_right": "ADJUST_BASE_RIGHT", "stay_same":"succeeded", "failed":"GET_IMAGE"}, 
            )
