...
class TorsoHeight(smach.State):
    ...
    def execute(self, userdata):
        ...
        pub = rospy.Publisher('/torso_controller/command', JointTrajectory, queue_size=10,latch=True)
        ...
        try:
            ...
            # Publish the command
                ...
                rospy.sleep(0.1)
            return 'succeeded'  # Wait for the duration of the movement plus a little extra
