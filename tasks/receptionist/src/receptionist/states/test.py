...
available_names = ['olivia', 'noah', 'amelia', 'liam', 'emma', 'oliver', 'sophia', 'elijah', 'charlotte', 'mateo', 'isabella', 'lucas', 'ava', 'levi', 'mia', 'ezra', 'ellie', 'asher', 'luna', 'leo', 'harper', 'james', 'aurora', 'luca', 'evelyn', 'henry', 'eliana', 'hudson', 'aria', 'ethan']

available_single_drinks = [
    "cola",
    "milk",
]
available_double_drinks = [
    "iced",
    "tea",
    "pack",
    "juice",
...
available_drinks = list(
    set(available_single_drinks).union(set(available_double_drinks))
)
excluded_words = [
    "my",
    "name",
...
if __name__ == "__main__":
    print(get_damerau_levenshtein_distance("ari", "ava"))
