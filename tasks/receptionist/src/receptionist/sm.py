...
from receptionist.states import LearnFaces
from receptionist.states import DetectFaces
from receptionist.states import FacePerson
...
class Receptionist(smach.StateMachine):
    def __init__(self):
        ...
        with self:
            ...
            smach.StateMachine.add('WAIT_FOR_PERSON', WaitForPersonInArea() ,transitions={'next_person' : 'GO_TO_PERSON', 'failed' : 'failed','succeeded':'FACE_PERSON'})
            ...
            smach.StateMachine.add('FACE_PERSON',FacePerson(self.default),transitions={'succeeded':'DETECT_FACES'})
