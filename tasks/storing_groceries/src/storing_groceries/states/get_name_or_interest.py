"""
State for parsing the transcription of the guests' information (interest or name), and adding this
...
class GetNameOrInterest(smach.StateMachine):
    class ParseTranscribedInfo(smach.State):
        ...
        def execute(self, userdata: UserData) -> str:
            ...
            Returns:
                str: state outcome. Updates the userdata with the parsed information (interest or name), under
            ...
            for key_phrase in self._possible_information:
                if key_phrase in transcription:
                    ...
                    rospy.loginfo(
                        f"Guest/Interest {self._type} identified as: {key_phrase}"
                    )
