...
class Recognise(yasmin.State):
    ...
    def execute(self, blackboard: Blackboard) -> str:
        ...
        yasmin.YASMIN_LOG_INFO(f"Depth image size: {depth_image.width}x{depth_image.height}")
        ...
        # DEBUG 3
        yasmin.YASMIN_LOG_INFO(f"YOLO detected {len(yolo_response.detected_objects)} object(s)")
        ...
        # DEBUG 4
        yasmin.YASMIN_LOG_INFO(f"Cropped image size: {cropped_rgb_image.width}x{cropped_rgb_image.height}")
