...
class Recognise(yasmin_ros.ServiceState):
    def __init__(self):
        ...
        depth_info = message_filters.Subscriber(
            self._node, CameraInfo, 'head_front_camera/depth/camera_info', qos_profile=camera_qos
        )
        ...
        depth_sub = message_filters.Subscriber(
            self._node, Image, 'head_front_camera/depth/image_raw', qos_profile=camera_qos
        )
