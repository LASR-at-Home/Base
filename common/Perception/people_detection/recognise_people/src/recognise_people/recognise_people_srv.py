...
# ----
        ...
        #     response = []
        # detected_obj = []
        # detected_obj.append(yolo_resp)
        # detected_obj.append(face_detection_resp)
        # detected_obj = [item for sublist in detected_obj for item in sublist]
        # print(type(response))
        response.detected_objects = []
        # response.detected_objects = detected_obj
        return response
...
if __name__ == "__main__":
    ...
    service = rospy.Service('recognise_people_server', RecognisePeople, server)
