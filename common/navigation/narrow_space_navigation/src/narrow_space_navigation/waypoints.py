    ...
    def get_lift_information(self, is_lift, is_sim=True):
        ...
        if is_lift:
            ...
            if is_sim:
               ...
               # points = [[-0.3615887211220624, 31.821503961306803],
                #[-3.3194873825082496, 31.323157427897918],
                #[-3.8194536291669134, 34.27883870265908],
                #[-0.8615549677807264, 34.777185236067965]]
