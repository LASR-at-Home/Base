...
def test():
    ...
    service = rospy.ServiceProxy("completion_to_collision_object", GenerateCollisionObject)
    ...
    pub = rospy.Publisher("/collision_object", CollisionObject, queue_size=1, latch=True)
