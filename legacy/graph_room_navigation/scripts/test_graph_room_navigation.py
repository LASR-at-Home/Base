...
add_room(
    "1",
    Point(-0.19334179163, -4.55392599106, 0.0),
    Point(4.94751501083, 7.62173271179, 0.0),
)
add_room(
    "2",
    Point(2.69638562202, 7.27746152878, 0.0),
    Point(4.91735553741, 12.5359373093, 0.0),
)

add_doorway(
    "1",
    Point(4.51002217519, 6.80491190474, 0.0),
    "2",
    Point(4.51002217519, 8.30578852245, 0.0),
)
