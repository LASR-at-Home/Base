    ...
    if latest_pose is not None and (seconds - latest_pose.header.stamp.secs < 1.0):
        ...
        if is_rect:
            ...
            if table >= 0:
                ...
                rospy.set_param("/tables/table" + str(table) + "/objects_cuboid",
                                [corner_1, corner_2, corner_3, corner_4])
                rospy.set_param("/tables/table" + str(table) + "/persons_cuboid",
                                [padded_corner_1, padded_corner_2, padded_corner_3, padded_corner_4])
        ...
        rospy.logerr(
            "No pose data available to generate cuboid for table %d, please check if the marker is on the table", table)
        return GenerateTableCuboidResponse(False)
