...
class PointingDetecor(smach.State):
    def __init__(self):
        smach.State.__init__(self, outcomes=['succeeded', 'failed'], output_keys=['direction'])
        self.service = rospy.ServiceProxy('/pointing_detection_service', PointingDirection)
