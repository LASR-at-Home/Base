...
# # You can also access a specific group by name
# # e.g., to get the 'arm' group:
# arm_group = robot.get_group(group_names[0]) # Assumes the first group is 'arm'

# # You can then perform operations on the specific group
...
moveit_commander.roscpp_initialize(sys.argv)
rospy.init_node("send_goal_to_point", anonymous=True)
