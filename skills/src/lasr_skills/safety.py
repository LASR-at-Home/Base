...
class SafetySM(yasmin.StateMachine):
    def __init__(self):
        ...
        self.add_state(
            ...
            transitions={"succeeded": "START", "canceled": "WAIT_START"},
        )

        self.add_state(
            "START",
            start_con_sm,
            transitions={"succeeded": "CHANGE_NAV_PARAM", "failed": "START"},
        )

        self.add_state(
            "CHANGE_NAV_PARAM",
            ChangeNavParam(),
            transitions={"succeeded": "SAY_GO_START_POINT", "aborted": "failed"},
        )
        ...
        self.add_state(
            ...
            transitions={
                "succeeded": "WAIT_FOR_END_POINT",
                "failed": "GO_TO_START_POINT",
            },
        )
        ...
        self.add_state(
            "WAIT_FOR_END_POINT",
            WaitState(),
            transitions={"succeeded": "SAY_GO_END_POINT", "failed": "failed"},
        )
        ...
        self.add_state(
            ...
            transitions={"succeeded": "succeeded", "failed": "GO_TO_END_POINT"},
        )
