...
: ${AMENT_CURRENT_PREFIX:="/home/haiwei/lasr/ros_ws/Base/install/cv2_img"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cv2_img/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cv2_img/environment/path.sh"
