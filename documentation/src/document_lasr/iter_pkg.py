...
def is_root(path):
    return os.path.exists(os.path.join(path, "build")) and os.path.exists(
        os.path.join(path, "devel")
    )


WORKSPACE_ROOT = FWD
while not is_root(WORKSPACE_ROOT) and os.path.dirname(WORKSPACE_ROOT) != WORKSPACE_ROOT:
